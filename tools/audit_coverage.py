...
PLAN = [
    ...
    #     ⏳ 待量：Harness 的 0.15 同样是「切一块」，开写本章时按实际用到的节实测
    #     （2.5 那份已经从 0.15 改成实测的 0.07）。全书「素材权重没与实际用到的节对过」
    #     这类错误已经出现两次，量法见 2.4/2.5 两处的做法。
    ("2", "2.6", "AI Harness：把 AI 编程接入工程流水线", 6000,
     [("file", "02-AI编程工具链/AI-Harness入门与实践.md", 0.15),
      ("file", "02-AI编程工具链/Claude-Code从入门到实战.md", 0.05),
      ("file", "02-AI编程工具链/Codex从入门到实战.md", 0.05)],
     "跨三份素材，须自行织合；Harness 权重待按节实测"),
