...
PLAN = [
    ...
    ("3", "3.3", "Agent 是什么：LLM + 规划 + 工具 + 记忆", 6000,
     ...
     " ＋ §4.3 三种视角 256 ＋ §5.1 无限循环 205 ＝ **1,906**；另加题库「单/多 Agent 循环」3,173"),
    ("3", "3.4", "规划与决策策略", 7000,
     [("file", "03-大模型与Agent原理/大模型与AI-Agent从0到1笔记.md", 0.03022),
      ("bank", "AI-Agent面试题合集-1038道.md", 0.095076)],
     "笔记 §3.3「规划模块」386；题库自有分章「Agent 规划与决策策略（86道）」31,355"
     "（该专题混入强化学习题）＋ 提示工程分章组11 的 Q1–7 任务分解/依赖/聚合 2,170"),
    ("3", "3.5", "工具调用与函数编排", 7000,
     [("file", "03-大模型与Agent原理/大模型与AI-Agent从0到1笔记.md", 0.10123),
      ("bank", "AI-Agent面试题合集-1038道.md", 0.122196)],
     "笔记 §3.5 工具集 770 ＋ §5.2 工具选择错误 315 ＋ §5.4 错误处理 208 ＝ 1,293；"
    ...
    ("3", "3.7", "多 Agent 协作框架设计", 6000,
     ...
     " ＋ 提示工程分章组11 的 Q8–10 多 Agent 提示协议 1,088；仍以原创为主"),
    ("3", "3.8", "安全、对齐与防护", 6000,
